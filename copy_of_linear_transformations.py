...
Original file is located at
    https://colab.research.google.com/drive/10MMjUC1cnzxGHxfRXAkazTIifOxl9Je4
...
def transform(x):
  # Put your code here.
  z=np.copy(x)
  y=np.array([2*z[0]+z[1], z[0]-3*z[1], z[1]])
...
def reflect(image,a,b): 
  # Put your code here.
  T=np.array([[(a**2-b**2)/(a**2+b**2),(2*a*b)/(a**2+b**2)],[(2*a*b)/(a**2+b**2),(b**2-a**2)/(a**2+b**2)]])
  y=matmul(T,image)
  return y # Put your return value here.
...
def area(A): 
  ...
  x=a*b*np.sin(np.arccos(np.dot(A[0, :], A[1, :])/np.dot(a, b)))
...
ellipse_area=area(ellipse_matrix) * np.pi
